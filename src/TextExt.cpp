...
TextExt::TextExt(const String& string, const Font& font, unsigned int characterSize) :
m_string             (string),
m_font               (&font),
...
void TextExt::setString(const String& string)
{
    if (m_string != string)
    {
        m_string = string;
...
void TextExt::setFont(const Font& font)
{
    if (m_font != &font)
    {
        m_font = &font;
...
void TextExt::setCharacterSize(unsigned int size)
{
...
void TextExt::setLetterSpacing(float spacingFactor)
{
...
void TextExt::setLineSpacing(float spacingFactor)
{
...
void TextExt::setStyle(Uint32 style)
{
    if (m_style != style)
    {
        m_style = style;
...
void TextExt::setFillColor(const Color& color)
{
...
void TextExt::setOutlineColor(const Color& color)
{
...
void TextExt::setOutlineThickness(float thickness)
{
...
const String& TextExt::getString() const
{
    return m_string;
}

const Font* TextExt::getFont() const
{
    return m_font;
}

unsigned int TextExt::getCharacterSize() const
{
    return m_characterSize;
}

float TextExt::getLetterSpacing() const
{
    return m_letterSpacingFactor;
}

float TextExt::getLineSpacing() const
{
    return m_lineSpacingFactor;
}

Uint32 TextExt::getStyle() const
{
    return m_style;
}

const Color& TextExt::getFillColor() const
{
    return m_fillColor;
}

const Color& TextExt::getOutlineColor() const
{
    return m_outlineColor;
}

float TextExt::getOutlineThickness() const
{
    return m_outlineThickness;
}

Vector2f TextExt::findCharacterPos(std::size_t index) const
{
...
void TextExt::ensureGeometryUpdate() const
{
    if (!m_font)
        return;
